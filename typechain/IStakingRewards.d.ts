...
export class IStakingRewards extends Contract {
  ...
  functions: {
    ...
    "earned(address)"(account: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    "earned(address)"(account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
